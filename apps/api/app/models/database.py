...
class ParsedCV(Base):
    ...
    api_key_id = Column(String(36), ForeignKey('parsescore.api_keys.id'), nullable=False)
...
class ScoringResult(Base):
    ...
    id = Column(String(36), primary_key=True, default=generate_uuid)
    request_id = Column(String(36), nullable=False, index=True)
    parsed_cv_id = Column(String(36), ForeignKey('parsescore.parsed_cvs.id'), nullable=False)
