...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "absolute right-3 top-3 rounded-md p-1.5 text-foreground/70 opacity-100 transition-all hover:bg-muted hover:text-foreground group-[.destructive]:text-destructive group-[.destructive]:hover:bg-destructive/10 focus:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring",
      className,
    )}
    toast-close=""
    {...props}
