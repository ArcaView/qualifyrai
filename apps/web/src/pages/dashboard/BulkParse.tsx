  ...
  const handleBulkParse = async () => {
    ...
    try {
      ...
      const updatedFiles = files.map((fileItem, index) => {
        ...
        // Extract data directly from API response (match ParseCV.tsx approach)
        ...
        const candidate = {
          ...
          linkedin_url: contact.linkedin_url || candidateData.linkedin_url,
          portfolio_url: contact.portfolio_url || candidateData.website_url,
